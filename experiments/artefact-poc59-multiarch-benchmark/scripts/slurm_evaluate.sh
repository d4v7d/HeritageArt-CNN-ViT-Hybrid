...
#SBATCH --error=logs/slurm/evaluate_%j.err

echo "================================"
echo "POC-5.9 Multi-Arch Evaluation Job"
...
echo ""
echo "🔬 Evaluating POC-5.9 Multi-Arch models..."
echo "Start: $(date)"
echo ""
